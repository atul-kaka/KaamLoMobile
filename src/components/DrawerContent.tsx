...
import { View, Text, StyleSheet, TouchableOpacity, ScrollView, Modal, Dimensions, Image, ImageSourcePropType } from 'react-native';
...
const makeInIndiaIcon: ImageSourcePropType = require('../assets/images/Make_In_India.png');
    ...
    <View style={styles.container}>
      <SafeAreaView style={styles.safeArea} edges={['top', 'bottom']}>
        ...
        <View style={styles.menuHeader}>
          <Text style={styles.allServicesText}>{t('allServices')}</Text>
          <TouchableOpacity 
        ...
        >
          ...
          >
            <Icon 
              ...
              style={styles.serviceIcon}
            />
            <Text style={styles.serviceItemText}>{t('home')}</Text>
          </TouchableOpacity>
        </DrawerContentScrollView>
        
        <View style={[styles.versionContainer, { paddingBottom: insets.bottom }]}>
          <Text style={styles.versionText}>{t('version')} {packageJson.version}</Text>
          <Image 
            source={makeInIndiaIcon} 
            style={styles.makeInIndiaIcon}
            resizeMode="contain"
          />
        </View>
      </SafeAreaView>
